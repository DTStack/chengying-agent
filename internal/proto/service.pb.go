...
func (ControlResponse_StopAgentOptions_StopAgentOptionsType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 4, 0}
}
...
func (Event_EventType) EnumDescriptor() ([]byte, []int) { return fileDescriptorService, []int{7, 0} }
...
func (*EmptyResponse) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{1} }

type SidecarRequestHeader struct {
	Id      Uuid      `protobuf:"bytes,1,opt,name=id,proto3,customtype=Uuid" json:"id"`
	Systime time.Time `protobuf:"bytes,2,opt,name=systime,stdtime" json:"systime"`
}

func (m *SidecarRequestHeader) Reset()                    { *m = SidecarRequestHeader{} }
func (*SidecarRequestHeader) ProtoMessage()               {}
func (*SidecarRequestHeader) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{2} }

type RegisterRequest struct {
	SidecarRequestHeader `protobuf:"bytes,1,opt,name=H,embedded=H" json:"H"`
	...
	CallBack             []string `protobuf:"bytes,11,rep,name=callBack" json:"callBack,omitempty"`
}

func (m *RegisterRequest) Reset()                    { *m = RegisterRequest{} }
func (*RegisterRequest) ProtoMessage()               {}
func (*RegisterRequest) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{3} }
...
func (*RegisterResponse) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{4} }
...
func (*ControlRequest) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{5} }
...
func (*ControlResponse) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{6} }
...
type ControlResponse_InstallAgentOptions_ struct {
	InstallAgentOptions *ControlResponse_InstallAgentOptions `protobuf:"bytes,100,opt,name=installAgentOptions,oneof"`
}
type ControlResponse_UninstallAgentOptions_ struct {
	UninstallAgentOptions *ControlResponse_UninstallAgentOptions `protobuf:"bytes,101,opt,name=uninstallAgentOptions,oneof"`
}
type ControlResponse_UpdateAgentOptions_ struct {
	UpdateAgentOptions *ControlResponse_UpdateAgentOptions `protobuf:"bytes,102,opt,name=updateAgentOptions,oneof"`
}
type ControlResponse_StartAgentOptions_ struct {
	StartAgentOptions *ControlResponse_StartAgentOptions `protobuf:"bytes,103,opt,name=startAgentOptions,oneof"`
}
type ControlResponse_StopAgentOptions_ struct {
	StopAgentOptions *ControlResponse_StopAgentOptions `protobuf:"bytes,104,opt,name=stopAgentOptions,oneof"`
}
type ControlResponse_UpdateAgentConfigOptions_ struct {
	UpdateAgentConfigOptions *ControlResponse_UpdateAgentConfigOptions `protobuf:"bytes,105,opt,name=updateAgentConfigOptions,oneof"`
}
type ControlResponse_UpdateSidecarOptions_ struct {
	UpdateSidecarOptions *ControlResponse_UpdateSidecarOptions `protobuf:"bytes,106,opt,name=updateSidecarOptions,oneof"`
}
type ControlResponse_UpdateSidecarConfigOptions_ struct {
	UpdateSidecarConfigOptions *ControlResponse_UpdateSidecarConfigOptions `protobuf:"bytes,107,opt,name=updateSidecarConfigOptions,oneof"`
}
type ControlResponse_ExecScriptOptions_ struct {
	ExecScriptOptions *ControlResponse_ExecScriptOptions `protobuf:"bytes,108,opt,name=execScriptOptions,oneof"`
}
type ControlResponse_CancelOptions_ struct {
	CancelOptions *ControlResponse_CancelOptions `protobuf:"bytes,109,opt,name=cancelOptions,oneof"`
}
type ControlResponse_ExecRestOptions_ struct {
	ExecRestOptions *ControlResponse_ExecRestOptions `protobuf:"bytes,110,opt,name=execRestOptions,oneof"`
}
...
func (*ControlResponse) XXX_OneofFuncs() (func(msg proto1.Message, b *proto1.Buffer) error, func(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error), func(msg proto1.Message) (n int), []interface{}) {
...
func _ControlResponse_OneofMarshaler(msg proto1.Message, b *proto1.Buffer) error {
	m := msg.(*ControlResponse)
	// options
	switch x := m.Options.(type) {
	case *ControlResponse_InstallAgentOptions_:
		_ = b.EncodeVarint(100<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.InstallAgentOptions); err != nil {
			return err
		}
	case *ControlResponse_UninstallAgentOptions_:
		_ = b.EncodeVarint(101<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.UninstallAgentOptions); err != nil {
			return err
		}
	case *ControlResponse_UpdateAgentOptions_:
		_ = b.EncodeVarint(102<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.UpdateAgentOptions); err != nil {
			return err
		}
	case *ControlResponse_StartAgentOptions_:
		_ = b.EncodeVarint(103<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.StartAgentOptions); err != nil {
			return err
		}
	case *ControlResponse_StopAgentOptions_:
		_ = b.EncodeVarint(104<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.StopAgentOptions); err != nil {
			return err
		}
	case *ControlResponse_UpdateAgentConfigOptions_:
		_ = b.EncodeVarint(105<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.UpdateAgentConfigOptions); err != nil {
			return err
		}
	case *ControlResponse_UpdateSidecarOptions_:
		_ = b.EncodeVarint(106<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.UpdateSidecarOptions); err != nil {
			return err
		}
	case *ControlResponse_UpdateSidecarConfigOptions_:
		_ = b.EncodeVarint(107<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.UpdateSidecarConfigOptions); err != nil {
			return err
		}
	case *ControlResponse_ExecScriptOptions_:
		_ = b.EncodeVarint(108<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.ExecScriptOptions); err != nil {
			return err
		}
	case *ControlResponse_CancelOptions_:
		_ = b.EncodeVarint(109<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.CancelOptions); err != nil {
			return err
		}
	case *ControlResponse_ExecRestOptions_:
		_ = b.EncodeVarint(110<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.ExecRestOptions); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("ControlResponse.Options has unexpected type %T", x)
	}
	return nil
}

func _ControlResponse_OneofUnmarshaler(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error) {
	m := msg.(*ControlResponse)
	switch tag {
	case 100: // options.installAgentOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_InstallAgentOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_InstallAgentOptions_{msg}
		return true, err
	case 101: // options.uninstallAgentOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_UninstallAgentOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_UninstallAgentOptions_{msg}
		return true, err
	case 102: // options.updateAgentOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_UpdateAgentOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_UpdateAgentOptions_{msg}
		return true, err
	case 103: // options.startAgentOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_StartAgentOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_StartAgentOptions_{msg}
		return true, err
	case 104: // options.stopAgentOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_StopAgentOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_StopAgentOptions_{msg}
		return true, err
	case 105: // options.updateAgentConfigOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_UpdateAgentConfigOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_UpdateAgentConfigOptions_{msg}
		return true, err
	case 106: // options.updateSidecarOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_UpdateSidecarOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_UpdateSidecarOptions_{msg}
		return true, err
	case 107: // options.updateSidecarConfigOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_UpdateSidecarConfigOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_UpdateSidecarConfigOptions_{msg}
		return true, err
	case 108: // options.execScriptOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_ExecScriptOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_ExecScriptOptions_{msg}
		return true, err
	case 109: // options.cancelOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_CancelOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_CancelOptions_{msg}
		return true, err
	case 110: // options.execRestOptions
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(ControlResponse_ExecRestOptions)
		err := b.DecodeMessage(msg)
		m.Options = &ControlResponse_ExecRestOptions_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ControlResponse_OneofSizer(msg proto1.Message) (n int) {
	m := msg.(*ControlResponse)
	// options
	switch x := m.Options.(type) {
	case *ControlResponse_InstallAgentOptions_:
		s := proto1.Size(x.InstallAgentOptions)
		n += proto1.SizeVarint(100<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_UninstallAgentOptions_:
		s := proto1.Size(x.UninstallAgentOptions)
		n += proto1.SizeVarint(101<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_UpdateAgentOptions_:
		s := proto1.Size(x.UpdateAgentOptions)
		n += proto1.SizeVarint(102<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_StartAgentOptions_:
		s := proto1.Size(x.StartAgentOptions)
		n += proto1.SizeVarint(103<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_StopAgentOptions_:
		s := proto1.Size(x.StopAgentOptions)
		n += proto1.SizeVarint(104<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_UpdateAgentConfigOptions_:
		s := proto1.Size(x.UpdateAgentConfigOptions)
		n += proto1.SizeVarint(105<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_UpdateSidecarOptions_:
		s := proto1.Size(x.UpdateSidecarOptions)
		n += proto1.SizeVarint(106<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_UpdateSidecarConfigOptions_:
		s := proto1.Size(x.UpdateSidecarConfigOptions)
		n += proto1.SizeVarint(107<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_ExecScriptOptions_:
		s := proto1.Size(x.ExecScriptOptions)
		n += proto1.SizeVarint(108<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_CancelOptions_:
		s := proto1.Size(x.CancelOptions)
		n += proto1.SizeVarint(109<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *ControlResponse_ExecRestOptions_:
		s := proto1.Size(x.ExecRestOptions)
		n += proto1.SizeVarint(110<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case nil:
	default:
...
type ControlResponse_InstallAgentOptions struct {
	...
	Parameter         []string      `protobuf:"bytes,4,rep,name=parameter" json:"parameter,omitempty"`
	Name              string        `protobuf:"bytes,5,opt,name=name,proto3" json:"name,omitempty"`
	InstallParameter  []string      `protobuf:"bytes,6,rep,name=installParameter" json:"installParameter,omitempty"`
	...
	HealthPeriod      time.Duration `protobuf:"bytes,10,opt,name=healthPeriod,stdduration" json:"healthPeriod"`
	Timeout           time.Duration `protobuf:"bytes,11,opt,name=timeout,stdduration" json:"timeout"`
	HealthStartPeriod time.Duration `protobuf:"bytes,12,opt,name=healthStartPeriod,stdduration" json:"healthStartPeriod"`
	HealthTimeout     time.Duration `protobuf:"bytes,13,opt,name=healthTimeout,stdduration" json:"healthTimeout"`
...
type ControlResponse_UninstallAgentOptions struct {
	AgentId         Uuid          `protobuf:"bytes,1,opt,name=agentId,proto3,customtype=Uuid" json:"agentId"`
	Parameter       []string      `protobuf:"bytes,2,rep,name=parameter" json:"parameter,omitempty"`
	UninstallScript string        `protobuf:"bytes,3,opt,name=uninstallScript,proto3" json:"uninstallScript,omitempty"`
	Timeout         time.Duration `protobuf:"bytes,4,opt,name=timeout,stdduration" json:"timeout"`
}
...
func (*ControlResponse_StartAgentOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 3}
}
...
func (*ControlResponse_StopAgentOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 4}
}
...
func (*ControlResponse_UpdateAgentConfigOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 5}
}
...
func (*ControlResponse_UpdateSidecarOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 6}
}
...
func (*ControlResponse_UpdateSidecarConfigOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 7}
}
...
func (*ControlResponse_ExecScriptOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 8}
}
...
func (*ControlResponse_CancelOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 9}
}
...
type ControlResponse_ExecRestOptions struct {
	...
	Timeout time.Duration `protobuf:"bytes,5,opt,name=timeout,stdduration" json:"timeout"`
...
func (*ControlResponse_ExecRestOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{6, 10}
}
...
type Event_OpProgress struct {
	OpProgress *Event_OperationProgress `protobuf:"bytes,100,opt,name=opProgress,oneof"`
}
type Event_AgentError_ struct {
	AgentError *Event_AgentError `protobuf:"bytes,101,opt,name=agentError,oneof"`
}
type Event_OsResourceUsages_ struct {
	OsResourceUsages *Event_OsResourceUsages `protobuf:"bytes,102,opt,name=osResourceUsages,oneof"`
}
type Event_ProcResourceUsages struct {
	ProcResourceUsages *Event_ProcessResourceUsages `protobuf:"bytes,103,opt,name=procResourceUsages,oneof"`
}
type Event_ExecScriptResponse_ struct {
	ExecScriptResponse *Event_ExecScriptResponse `protobuf:"bytes,104,opt,name=execScriptResponse,oneof"`
}
type Event_AgentHealthCheck_ struct {
	AgentHealthCheck *Event_AgentHealthCheck `protobuf:"bytes,105,opt,name=agentHealthCheck,oneof"`
}
type Event_ExecRestResponse_ struct {
	ExecRestResponse *Event_ExecRestResponse `protobuf:"bytes,106,opt,name=execRestResponse,oneof"`
}
...
func _Event_OneofMarshaler(msg proto1.Message, b *proto1.Buffer) error {
	...
	case *Event_OpProgress:
		_ = b.EncodeVarint(100<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.OpProgress); err != nil {
			return err
		}
	case *Event_AgentError_:
		_ = b.EncodeVarint(101<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.AgentError); err != nil {
			return err
		}
	case *Event_OsResourceUsages_:
		_ = b.EncodeVarint(102<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.OsResourceUsages); err != nil {
			return err
		}
	case *Event_ProcResourceUsages:
		_ = b.EncodeVarint(103<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.ProcResourceUsages); err != nil {
			return err
		}
	case *Event_ExecScriptResponse_:
		_ = b.EncodeVarint(104<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.ExecScriptResponse); err != nil {
			return err
		}
	case *Event_AgentHealthCheck_:
		_ = b.EncodeVarint(105<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.AgentHealthCheck); err != nil {
			return err
		}
	case *Event_ExecRestResponse_:
		_ = b.EncodeVarint(106<<3 | proto1.WireBytes)
		if err := b.EncodeMessage(x.ExecRestResponse); err != nil {
			return err
		}
	case nil:
	default:
...
func _Event_OneofUnmarshaler(msg proto1.Message, tag, wire int, b *proto1.Buffer) (bool, error) {
	m := msg.(*Event)
	switch tag {
	case 100: // details.opProgress
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(Event_OperationProgress)
		err := b.DecodeMessage(msg)
		m.Details = &Event_OpProgress{msg}
		return true, err
	case 101: // details.agentError
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(Event_AgentError)
		err := b.DecodeMessage(msg)
		m.Details = &Event_AgentError_{msg}
		return true, err
	case 102: // details.osResourceUsages
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(Event_OsResourceUsages)
		err := b.DecodeMessage(msg)
		m.Details = &Event_OsResourceUsages_{msg}
		return true, err
	case 103: // details.procResourceUsages
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(Event_ProcessResourceUsages)
		err := b.DecodeMessage(msg)
		m.Details = &Event_ProcResourceUsages{msg}
		return true, err
	case 104: // details.execScriptResponse
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(Event_ExecScriptResponse)
		err := b.DecodeMessage(msg)
		m.Details = &Event_ExecScriptResponse_{msg}
		return true, err
	case 105: // details.agentHealthCheck
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(Event_AgentHealthCheck)
		err := b.DecodeMessage(msg)
		m.Details = &Event_AgentHealthCheck_{msg}
		return true, err
	case 106: // details.execRestResponse
		if wire != proto1.WireBytes {
			return true, proto1.ErrInternalBadWireType
		}
		msg := new(Event_ExecRestResponse)
		err := b.DecodeMessage(msg)
		m.Details = &Event_ExecRestResponse_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Event_OneofSizer(msg proto1.Message) (n int) {
	...
	switch x := m.Details.(type) {
	case *Event_OpProgress:
		s := proto1.Size(x.OpProgress)
		n += proto1.SizeVarint(100<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Event_AgentError_:
		s := proto1.Size(x.AgentError)
		n += proto1.SizeVarint(101<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Event_OsResourceUsages_:
		s := proto1.Size(x.OsResourceUsages)
		n += proto1.SizeVarint(102<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Event_ProcResourceUsages:
		s := proto1.Size(x.ProcResourceUsages)
		n += proto1.SizeVarint(103<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Event_ExecScriptResponse_:
		s := proto1.Size(x.ExecScriptResponse)
		n += proto1.SizeVarint(104<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Event_AgentHealthCheck_:
		s := proto1.Size(x.AgentHealthCheck)
		n += proto1.SizeVarint(105<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case *Event_ExecRestResponse_:
		s := proto1.Size(x.ExecRestResponse)
		n += proto1.SizeVarint(106<<3 | proto1.WireBytes)
		n += proto1.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*Event_AgentError) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{7, 1} }
...
type Event_OsResourceUsages struct {
	...
	DiskUsage []Event_DiskUsage `protobuf:"bytes,6,rep,name=diskUsage" json:"diskUsage"`
	NetStats  []Event_NetStat   `protobuf:"bytes,7,rep,name=netStats" json:"netStats"`
}
...
func (*Event_DiskUsage) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{7, 3} }

type Event_NetStat struct {
	IfName    string   `protobuf:"bytes,1,opt,name=ifName,proto3" json:"ifName,omitempty"`
	IfIp      []string `protobuf:"bytes,2,rep,name=ifIp" json:"ifIp,omitempty"`
...
func (*Event_NetStat) Descriptor() ([]byte, []int) { return fileDescriptorService, []int{7, 4} }
...
func (*Event_ProcessResourceUsages) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{7, 5}
}
...
func (*Event_ExecScriptResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{7, 6}
}
...
func (*Event_AgentHealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{7, 7}
}
...
func (*Event_ExecRestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorService, []int{7, 8}
}

func init() {
	proto1.RegisterType((*Msg)(nil), "proto.Msg")
	proto1.RegisterType((*EmptyResponse)(nil), "proto.EmptyResponse")
	proto1.RegisterType((*SidecarRequestHeader)(nil), "proto.SidecarRequestHeader")
	proto1.RegisterType((*RegisterRequest)(nil), "proto.RegisterRequest")
	proto1.RegisterType((*RegisterResponse)(nil), "proto.RegisterResponse")
	proto1.RegisterType((*ControlRequest)(nil), "proto.ControlRequest")
	proto1.RegisterType((*ControlResponse)(nil), "proto.ControlResponse")
	proto1.RegisterType((*ControlResponse_InstallAgentOptions)(nil), "proto.ControlResponse.InstallAgentOptions")
	proto1.RegisterType((*ControlResponse_UninstallAgentOptions)(nil), "proto.ControlResponse.UninstallAgentOptions")
	proto1.RegisterType((*ControlResponse_UpdateAgentOptions)(nil), "proto.ControlResponse.UpdateAgentOptions")
	proto1.RegisterType((*ControlResponse_StartAgentOptions)(nil), "proto.ControlResponse.StartAgentOptions")
	proto1.RegisterType((*ControlResponse_StopAgentOptions)(nil), "proto.ControlResponse.StopAgentOptions")
	proto1.RegisterType((*ControlResponse_UpdateAgentConfigOptions)(nil), "proto.ControlResponse.UpdateAgentConfigOptions")
	proto1.RegisterType((*ControlResponse_UpdateSidecarOptions)(nil), "proto.ControlResponse.UpdateSidecarOptions")
	proto1.RegisterType((*ControlResponse_UpdateSidecarConfigOptions)(nil), "proto.ControlResponse.UpdateSidecarConfigOptions")
	proto1.RegisterType((*ControlResponse_ExecScriptOptions)(nil), "proto.ControlResponse.ExecScriptOptions")
	proto1.RegisterType((*ControlResponse_CancelOptions)(nil), "proto.ControlResponse.CancelOptions")
	proto1.RegisterType((*ControlResponse_ExecRestOptions)(nil), "proto.ControlResponse.ExecRestOptions")
	proto1.RegisterType((*Event)(nil), "proto.Event")
	proto1.RegisterType((*Event_OperationProgress)(nil), "proto.Event.OperationProgress")
	proto1.RegisterType((*Event_AgentError)(nil), "proto.Event.AgentError")
	proto1.RegisterType((*Event_OsResourceUsages)(nil), "proto.Event.OsResourceUsages")
	proto1.RegisterType((*Event_DiskUsage)(nil), "proto.Event.DiskUsage")
	proto1.RegisterType((*Event_NetStat)(nil), "proto.Event.NetStat")
	proto1.RegisterType((*Event_ProcessResourceUsages)(nil), "proto.Event.ProcessResourceUsages")
	proto1.RegisterType((*Event_ExecScriptResponse)(nil), "proto.Event.ExecScriptResponse")
	proto1.RegisterType((*Event_AgentHealthCheck)(nil), "proto.Event.AgentHealthCheck")
	proto1.RegisterType((*Event_ExecRestResponse)(nil), "proto.Event.ExecRestResponse")
	proto1.RegisterEnum("proto.ControlResponse_ControlCmd", ControlResponse_ControlCmd_name, ControlResponse_ControlCmd_value)
	proto1.RegisterEnum("proto.ControlResponse_StopAgentOptions_StopAgentOptionsType", ControlResponse_StopAgentOptions_StopAgentOptionsType_name, ControlResponse_StopAgentOptions_StopAgentOptionsType_value)
	proto1.RegisterEnum("proto.Event_EventType", Event_EventType_name, Event_EventType_value)
}
...
func (this *Event_OsResourceUsages) GoString() string {
	...
	if this.NetStats != nil {
		s = append(s, "NetStats: "+fmt.Sprintf("%#v", this.NetStats)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
// Client API for EasyAgentService service
...
func (c *easyAgentServiceClient) RegisterSidecar(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := grpc.Invoke(ctx, "/proto.EasyAgentService/registerSidecar", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *easyAgentServiceClient) ReadyForControl(ctx context.Context, in *ControlRequest, opts ...grpc.CallOption) (EasyAgentService_ReadyForControlClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_EasyAgentService_serviceDesc.Streams[0], c.cc, "/proto.EasyAgentService/readyForControl", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *easyAgentServiceClient) ReportEvent(ctx context.Context, in *Event, opts ...grpc.CallOption) (*EmptyResponse, error) {
	...
	err := grpc.Invoke(ctx, "/proto.EasyAgentService/reportEvent", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for EasyAgentService service
...
func (c *transferServiceClient) Send(ctx context.Context, in *Msg, opts ...grpc.CallOption) (*EmptyResponse, error) {
	out := new(EmptyResponse)
	err := grpc.Invoke(ctx, "/proto.TransferService/send", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (m *SidecarRequestHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.Systime)))
	n2, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Systime, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n2
...
func (m *RegisterRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintService(dAtA, i, uint64(m.SidecarRequestHeader.Size()))
	n3, err := m.SidecarRequestHeader.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
...
func (m *ControlRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintService(dAtA, i, uint64(m.SidecarRequestHeader.Size()))
	n4, err := m.SidecarRequestHeader.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (m *ControlResponse_InstallAgentOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.InstallAgentOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.InstallAgentOptions.Size()))
		n6, err := m.InstallAgentOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *ControlResponse_UninstallAgentOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UninstallAgentOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.UninstallAgentOptions.Size()))
		n7, err := m.UninstallAgentOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *ControlResponse_UpdateAgentOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateAgentOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.UpdateAgentOptions.Size()))
		n8, err := m.UpdateAgentOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *ControlResponse_StartAgentOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StartAgentOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.StartAgentOptions.Size()))
		n9, err := m.StartAgentOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *ControlResponse_StopAgentOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StopAgentOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.StopAgentOptions.Size()))
		n10, err := m.StopAgentOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *ControlResponse_UpdateAgentConfigOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateAgentConfigOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.UpdateAgentConfigOptions.Size()))
		n11, err := m.UpdateAgentConfigOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *ControlResponse_UpdateSidecarOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateSidecarOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.UpdateSidecarOptions.Size()))
		n12, err := m.UpdateSidecarOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *ControlResponse_UpdateSidecarConfigOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UpdateSidecarConfigOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.UpdateSidecarConfigOptions.Size()))
		n13, err := m.UpdateSidecarConfigOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *ControlResponse_ExecScriptOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExecScriptOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.ExecScriptOptions.Size()))
		n14, err := m.ExecScriptOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
func (m *ControlResponse_CancelOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CancelOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.CancelOptions.Size()))
		n15, err := m.CancelOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *ControlResponse_ExecRestOptions_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExecRestOptions != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.ExecRestOptions.Size()))
		n16, err := m.ExecRestOptions.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *ControlResponse_InstallAgentOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ConfigurationPath) > 0 {
		...
		i += copy(dAtA[i:], m.ConfigurationPath)
	}
	...
	if len(m.HealthShell) > 0 {
		...
		i += copy(dAtA[i:], m.HealthShell)
	}
	dAtA[i] = 0x52
	i++
	i = encodeVarintService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.HealthPeriod)))
	n18, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.HealthPeriod, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n18
	dAtA[i] = 0x5a
	i++
	i = encodeVarintService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.Timeout)))
	n19, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Timeout, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n19
	dAtA[i] = 0x62
	i++
	i = encodeVarintService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.HealthStartPeriod)))
	n20, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.HealthStartPeriod, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n20
	dAtA[i] = 0x6a
	i++
	i = encodeVarintService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.HealthTimeout)))
	n21, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.HealthTimeout, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n21
...
func (m *ControlResponse_UninstallAgentOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.UninstallScript) > 0 {
		...
		i += copy(dAtA[i:], m.UninstallScript)
	}
	dAtA[i] = 0x22
	i++
	i = encodeVarintService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.Timeout)))
...
func (m *ControlResponse_StartAgentOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CpuLimit != 0 {
		dAtA[i] = 0x15
		i++
		i = encodeFixed32Service(dAtA, i, uint32(math.Float32bits(float32(m.CpuLimit))))
	}
	if m.MemLimit != 0 {
		dAtA[i] = 0x18
		i++
...
func (m *ControlResponse_ExecScriptOptions) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ExecScript) > 0 {
		...
		i += copy(dAtA[i:], m.ExecScript)
	}
	dAtA[i] = 0x1a
	i++
	i = encodeVarintService(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.Timeout)))
	n29, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Timeout, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n29
	...
	i++
	i = encodeVarintService(dAtA, i, uint64(m.AgentId.Size()))
	n30, err := m.AgentId.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n30
...
func (m *Event) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintService(dAtA, i, uint64(m.SidecarRequestHeader.Size()))
	n34, err := m.SidecarRequestHeader.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n34
...
func (m *Event_OpProgress) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OpProgress != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.OpProgress.Size()))
		n36, err := m.OpProgress.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *Event_AgentError_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AgentError != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.AgentError.Size()))
		n37, err := m.AgentError.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *Event_OsResourceUsages_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OsResourceUsages != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.OsResourceUsages.Size()))
		n38, err := m.OsResourceUsages.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *Event_ProcResourceUsages) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProcResourceUsages != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.ProcResourceUsages.Size()))
		n39, err := m.ProcResourceUsages.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *Event_ExecScriptResponse_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExecScriptResponse != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.ExecScriptResponse.Size()))
		n40, err := m.ExecScriptResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *Event_AgentHealthCheck_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AgentHealthCheck != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.AgentHealthCheck.Size()))
		n41, err := m.AgentHealthCheck.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *Event_ExecRestResponse_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExecRestResponse != nil {
		...
		dAtA[i] = 0x6
		i++
		i = encodeVarintService(dAtA, i, uint64(m.ExecRestResponse.Size()))
		n42, err := m.ExecRestResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
...
func (m *Event_OperationProgress) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Progress != 0 {
		dAtA[i] = 0x1d
		i++
		i = encodeFixed32Service(dAtA, i, uint32(math.Float32bits(float32(m.Progress))))
	}
	if m.Failed {
		dAtA[i] = 0x20
		i++
...
func (m *Event_OsResourceUsages) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CpuUsage != 0 {
		dAtA[i] = 0xd
		i++
		i = encodeFixed32Service(dAtA, i, uint32(math.Float32bits(float32(m.CpuUsage))))
	}
	if m.MemUsage != 0 {
		dAtA[i] = 0x10
		i++
	...
	if m.Load1 != 0 {
		dAtA[i] = 0x25
		i++
		i = encodeFixed32Service(dAtA, i, uint32(math.Float32bits(float32(m.Load1))))
	}
	if m.Uptime != 0 {
		dAtA[i] = 0x29
		i++
		i = encodeFixed64Service(dAtA, i, uint64(math.Float64bits(float64(m.Uptime))))
	}
	if len(m.DiskUsage) > 0 {
		for _, msg := range m.DiskUsage {
			dAtA[i] = 0x32
			i++
...
func (this *SidecarRequestHeader) String() string {
	...
	s := strings.Join([]string{`&SidecarRequestHeader{`,
		`Id:` + fmt.Sprintf("%v", this.Id) + `,`,
		`Systime:` + strings.Replace(strings.Replace(this.Systime.String(), "Timestamp", "google_protobuf.Timestamp", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *ControlResponse_InstallAgentOptions) String() string {
	...
	s := strings.Join([]string{`&ControlResponse_InstallAgentOptions{`,
		...
		`HealthPeriod:` + strings.Replace(strings.Replace(this.HealthPeriod.String(), "Duration", "google_protobuf1.Duration", 1), `&`, ``, 1) + `,`,
		`Timeout:` + strings.Replace(strings.Replace(this.Timeout.String(), "Duration", "google_protobuf1.Duration", 1), `&`, ``, 1) + `,`,
		`HealthStartPeriod:` + strings.Replace(strings.Replace(this.HealthStartPeriod.String(), "Duration", "google_protobuf1.Duration", 1), `&`, ``, 1) + `,`,
		`HealthTimeout:` + strings.Replace(strings.Replace(this.HealthTimeout.String(), "Duration", "google_protobuf1.Duration", 1), `&`, ``, 1) + `,`,
...
func (this *Event_OsResourceUsages) String() string {
	...
	s := strings.Join([]string{`&Event_OsResourceUsages{`,
		...
		`DiskUsage:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.DiskUsage), "Event_DiskUsage", "Event_DiskUsage", 1), `&`, ``, 1) + `,`,
		`NetStats:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.NetStats), "Event_NetStat", "Event_NetStat", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
