...
func templatesInstallScriptWrapperSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/install.script.wrapper.sh", size: 1342, mode: os.FileMode(420), modTime: time.Unix(1615174048, 0)}
...
func templatesInstallSidecarSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/install.sidecar.sh", size: 11947, mode: os.FileMode(420), modTime: time.Unix(1615208472, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesInstallSidecarWinPs1() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/install.sidecar.win.ps1", size: 8926, mode: os.FileMode(420), modTime: time.Unix(1615173933, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
