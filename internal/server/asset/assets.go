...
func templatesEasyagent_install_4winPs1() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/easyagent_install_4win.ps1", size: 9674, mode: os.FileMode(420), modTime: time.Unix(1622552545, 0)}
...
func templatesInstallScriptWrapperSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/install.script.wrapper.sh", size: 1342, mode: os.FileMode(420), modTime: time.Unix(1622552545, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
Install_Sidecar(){
    ...
    if [ -e ${SIDECAR_DIR}/easyagent-sidecar ];then
       Echo_Red "Sidecar has been installed. Do not reinstall sidecar..."
       exit 1
    fi
...
func templatesInstallSidecarSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/install.sidecar.sh", size: 11947, mode: os.FileMode(420), modTime: time.Unix(1622552545, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func templatesInstallSidecarWinPs1() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/install.sidecar.win.ps1", size: 8926, mode: os.FileMode(420), modTime: time.Unix(1622552545, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
